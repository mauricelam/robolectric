...
public class ShadowActivityTest {
  ...
  public void recreateGoesThroughFullLifeCycle() throws Exception {
    ...
    assertThat(activity.transcript).containsExactly("onSaveInstanceState", "onPause", "onStop", "onRetainNonConfigurationInstance", "onDestroy", "onCreate", "onStart", "onRestoreInstanceState", "onResume");
